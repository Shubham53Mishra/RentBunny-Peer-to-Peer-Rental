...
// Required fields for bike ad update
...
$tables = ['petrol_bike_adds', 'electric_bike_adds'];
$table_name = '';
...
if($conn->query($update_sql)) {
    ...
    $response['message'] = 'Bike ad updated successfully';
    $response['data'] = [
        'add_id' => $add_id,
    ...
    $response['message'] = 'Failed to update bike ad: ' . $conn->error;
}
