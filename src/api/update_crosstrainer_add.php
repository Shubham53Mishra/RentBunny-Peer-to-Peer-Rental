...
// Required fields for crosstrainer ad update
$required_fields = ['max_user_weight', 'brand', 'product_type', 'price_per_month', 'security_deposit', 'ad_title', 'description', 'add_id'];
...
if($conn->query($update_sql)) {
    ...
    $response['message'] = 'Crosstrainer ad updated successfully';
    $response['data'] = [
        'add_id' => $add_id,
    ...
    $response['message'] = 'Failed to update crosstrainer ad: ' . $conn->error;
}
