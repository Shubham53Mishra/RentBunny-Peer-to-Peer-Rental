...
$allowed_fields = ['title', 'description', 'price_per_month', 'security_deposit', 'city', 'latitude', 'longitude', 'brand'];
...
if($conn->query($update_sql)) {
    ...
    $response['message'] = 'Tabla ad updated successfully';
    $response['data'] = [
        'add_id' => $add_id,
        'table' => $table_name,
    ...
    $response['message'] = 'Failed to update tabla ad';
