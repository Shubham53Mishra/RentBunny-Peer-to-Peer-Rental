...
$burner_count = isset($input['burner_count']) ? mysqli_real_escape_string($conn, $input['burner_count']) : null;
...
$title = null;
if($product_type && $brand && $burner_count) {
...
if($conn->query($update_sql)) {
    ...
    $response['message'] = 'Failed to update hob ad: ' . $conn->error;
}
