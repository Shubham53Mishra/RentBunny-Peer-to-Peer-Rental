...
$table_name = 'petrol_car_adds';
if(strtolower($product_type) == 'electric') {
    $table_name = 'electric_car_adds';
}
...
if($conn->query($insert_sql)) {
    ...
    $response['message'] = 'Car ad posted successfully';
    $response['data'] = [
        'add_id' => $add_id,
        'table' => $table_name,
    ...
    $response['message'] = 'Failed to post car ad';
