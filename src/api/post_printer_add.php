...
// Required fields for Printer ad
...
// Sanitize input
$paper_size = mysqli_real_escape_string($conn, $input['paper_size']);
...
if($conn->query($insert_sql)) {
    ...
    $response['message'] = 'Printer ad posted successfully';
    $response['data'] = [
        'id' => $add_id,
        'user_id' => $user_id,
        'ad_title' => $ad_title,
    ...
    $response['message'] = 'Failed to post printer ad';
