...
// Required fields for AC ad update
$required_fields = ['power_requirements', 'capacity', 'brand', 'product_type', 'price_per_month', 'security_deposit', 'ad_title', 'description', 'add_id'];
