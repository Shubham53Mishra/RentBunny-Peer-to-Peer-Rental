...
// Required fields for dining table ad update
...
if($conn->query($update_sql)) {
    ...
    $response['message'] = 'Dining table ad updated successfully';
    $response['data'] = [
        'add_id' => $add_id,
    ...
    $response['message'] = 'Failed to update dining table ad: ' . $conn->error;
}
