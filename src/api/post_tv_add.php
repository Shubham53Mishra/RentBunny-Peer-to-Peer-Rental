...
$required_fields = ['size', 'brand', 'product_type', 'price_per_month', 'security_deposit', 'ad_title', 'description', 'latitude', 'longitude', 'city', 'image_urls'];
...
if($conn->query($insert_sql)) {
    ...
    $response['message'] = 'TV ad posted successfully';
    $response['data'] = [
        'id' => $add_id,
        'user_id' => $user_id,
        'ad_title' => $ad_title,
