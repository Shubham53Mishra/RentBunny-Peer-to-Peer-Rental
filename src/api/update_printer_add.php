...
$paper_size = isset($input['paper_size']) ? mysqli_real_escape_string($conn, $input['paper_size']) : null;
...
if($conn->query($update_sql)) {
    ...
    $response['message'] = 'Printer ad updated successfully';
    $response['data'] = [
        'add_id' => $add_id,
    ...
    $response['message'] = 'Failed to update printer ad: ' . $conn->error;
}
