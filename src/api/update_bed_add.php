...
$required_fields = ['frame_material', 'storage_included', 'product_type', 'price_per_month', 'security_deposit', 'ad_title', 'description', 'add_id'];
...
$storage_included = intval($input['storage_included']);
...
// Update database
$update_sql = "UPDATE $table_name SET frame_material = '$frame_material', storage_included = '$storage_included', 
               product_type = '$product_type', price_per_month = '$price_per_month', security_deposit = '$security_deposit', 
               ad_title = '$ad_title', description = '$description', updated_at = NOW() WHERE id = '$add_id' AND user_id = '$user_id'";
