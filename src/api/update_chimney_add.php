...
$suction_capacity = isset($input['suction_capacity']) ? mysqli_real_escape_string($conn, $input['suction_capacity']) : null;
$model = isset($input['model']) ? mysqli_real_escape_string($conn, $input['model']) : null;
$voltage = isset($input['voltage']) ? mysqli_real_escape_string($conn, $input['voltage']) : null;
$filter_type = isset($input['filter_type']) ? mysqli_real_escape_string($conn, $input['filter_type']) : null;
...
if($conn->query($update_sql)) {
    ...
    $response['message'] = 'Chimney ad updated successfully';
    $response['data'] = [
        'add_id' => $add_id,
    ...
    $response['message'] = 'Failed to update chimney ad: ' . $conn->error;
}
